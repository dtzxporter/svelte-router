  ...
  window.addEventListener('click', (event) => {
    ...
    if (targetHostNameInternal && prefixMatchPath) {
      ...
      if (event.target.target === '_blank') {
        ...
        // Links should properly scroll the content back to top
        window.scrollTo(0, 0);
        navigateTo(destinationUrl);
      }
    }
...
/* src/components/route.svelte generated by Svelte v3.34.0 */
...
/* src/components/router.svelte generated by Svelte v3.34.0 */
...
/* src/components/navigate.svelte generated by Svelte v3.34.0 */
...
export { Navigate, Route, Router, SpaRouter, currentRoute, localisedRoute, navigateTo, routeIsActive };
